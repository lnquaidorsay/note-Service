...
import fr.ln.training.noteservice.repository.RoomRepository;
...
public class RoomServiceImpl implements IRoomService {
    ...
    public RoomDTO getRoomByNumber(String roomNumber) throws RoomNotFoundException {
        ...
        Optional<Room> roomFromDb = roomRepository.findByRoomNumber(roomNumber);
        Room room = roomFromDb.orElse(null);
        if (room == null) {
